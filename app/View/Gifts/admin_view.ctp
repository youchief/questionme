<div class="gifts view">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="btn-group">
                <?php echo $this->Html->link(__('Donner à CYCY'), array('action' => 'give_to_3xw', $gift['Gift']['id'], 41), array('class' => 'btn btn-lg btn-primary')); ?>
                <?php echo $this->Html->link(__('Donner à DADA'), array('action' => 'give_to_3xw', $gift['Gift']['id'], 39), array('class' => 'btn btn-lg btn-primary')); ?>
            </div>
        </div>
    </div>
