<div class="questions index">
        ...
        <table cellpadding="0" cellspacing="0" class="table">
                <tr>
                                                        ...
                                                        <th><?php echo $this->Paginator->sort('dependance_choice_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($question['Question']['media']); ?>&nbsp;</td>
		<td><?php echo h($question['Question']['media_type']); ?>&nbsp;</td>
		<td><?php echo h($question['Question']['dependance_choice_id']); ?>&nbsp;</td>
		<td><?php echo h($question['Question']['priority']); ?>&nbsp;</td>
