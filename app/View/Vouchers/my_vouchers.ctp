<div class='container'>
                        ...
                        <?php if ($bgift['used'] == null): ?>
                                <div class='col-sm-4'>
                                        <div class='thumbnail bigGift'>
                                                ...
                                                <p><b>Valable jusqu'au: </b><?php echo $this->Time->format('d/m/Y', $bgift['validity']); ?></p>
                                                <p>
                                                        <?php
                        ...
                        <?php if ($gift['used'] == null): ?>
                                <div class='col-sm-4'>
                                        <div class='thumbnail gift'>
                                                ...
                                                <p><b>Valable jusqu'au: </b><?php echo $this->Time->format('d/m/Y', $gift['validity']); ?></p>
        ...
        <div class='row'>
                ...
                <div class='col-sm-4'>
                        <?php
                        for ($i = 0; $i < count($vouchers); $i++):$voucher = $vouchers[$i];
                                if ($i % 3 == 0):
                                        ?>
